...
def build_parser() -> argparse.ArgumentParser:
    ...
    run_parser.add_argument("--profile", required=True, choices=["node-all", "python-audits", "frontend-build", "rust-static", "p0-preflight", "home-vitality-offline", "save-coordinator-offline", "asset-store-offline", "workspace-persistence-offline", "welfare-sign-in-offline", "p0-safety-boundary", "ui-viewports"])
